      ...
      <div style={{ display: "flex", height: "calc(100vh - 65px)" }}>
        ...
        <div style={{ flex: 1, overflowY: "auto", backgroundColor: "#f8fafc" }}>
          {viewMode === "statistics" ? (
            ...
            <PatientReport patient={selectedPatient} reportType="patient" isEditMode={false} onRequestEdit={() => {}} />
                  ...
                  <div style={{ display: "flex", gap: "12px" }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        border: "none",
                        backgroundColor:
                          newPatientData.name.trim() && newPatientData.dateOfBirth ? "#0891b2" : "#d1d5db",
                        color: "white",
            ...
            <div style={{ padding: "24px" }}>
                    ...
                    {isEditingPatient ? (
                        ...
                        <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                setEditPatientData({ ...editPatientData, age: parseInt(e.target.value) || 0 })
                              }
                              style={{
                                padding: "8px 12px",
                                borderRadius: "8px",
                      ...
                      <>
                        ...
                        <p style={{ color: "#6b7280", marginTop: "2px" }}>
                          DOB: {new Date(selectedPatient.dateOfBirth).toLocaleDateString()} | Patient since:{" "}
                          {selectedPatient.createdAt.toLocaleDateString()}
                        </p>
              ...
              >
                <h3 style={{ fontSize: "18px", fontWeight: 600, marginBottom: "16px" }}>
                  All Scans ({selectedPatient.scans.length})
                </h3>
                <div
      ...
      {expandedScan && (
        ...
        >
          ...
          >
            ...
            <h3 style={{ fontSize: "20px", fontWeight: 600, marginBottom: "16px" }}>{expandedScan.name}</h3>
            ...
            >
              {/* Fundus Image */}
              <div>
                <p style={{ fontSize: "14px", fontWeight: 600, marginBottom: "8px", color: "#374151" }}>Fundus Image</p>
                <img
                  ...
                  {expandedScan.diseases.map((disease, idx) => (
                    <span
                      ...
                      style={{
                        ...
                        fontWeight: 500,
                        backgroundColor:
                          disease.probability >= 70 ? "#fef2f2" : disease.probability >= 40 ? "#fffbeb" : "#f0fdf4",
                        color:
                          disease.probability >= 70 ? "#dc2626" : disease.probability >= 40 ? "#d97706" : "#22c55e",
                      }}
                    >
