export function DiseaseRiskBar({ disease }) {
    const getColor = () => {
        if (disease.probability >= 70)
            return '#ef4444';
        if (disease.probability >= 40)
            return '#f59e0b';
        return '#22c55e';
    };
    const getBgColor = () => {
    ...
    return (<div style={{ backgroundColor: 'white', border: '1px solid #e5e7eb', borderRadius: '8px', padding: '12px' }}>
