...
export function AnalysisPanel({ scan, viewMode, allScans, onUploadClick }) {
    if (!scan) {
        return (<div style={{ height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f9fafb' }}>
    ...
    return (<div style={{ height: '100%', padding: '24px', overflow: 'auto', backgroundColor: '#f9fafb' }}>
